...
namespace WebApiNetCore.Controllers
{
    ...
    public class ProductCategoriesController : ControllerBase
    {
        ...
        /// <summary>
        /// Devuelve el listado de categorías desde la base de datos
        /// </summary>
        /// <returns>ProductCategory<see cref="ProductCategory"/></returns>
        [HttpGet]
        ...
        /// <summary>
        /// Devuelve los datos de la categoría indicada
        /// </summary>
        ...
        public async Task<ActionResult<ProductCategory>> PostProductCategory(ProductCategory productCategory)
        {
          if (_context.ProductCategories == null)
          {
              return Problem("Entity set 'AdventureWorksContext.ProductCategories'  is null.");
          }
